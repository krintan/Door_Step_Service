...
<head>
    ...
    <script>
     ...
     <% 
         String vem=(String)session.getAttribute("Vendor_Email");
     %>
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    for (var i = 0; i < arr.length; i++)
                    {
                        ...
                        if (singleobj.status === "Pending")
                        {
                            ...
                            ans += "<div class=\"row\"><lable style=\"font-size: 15px;\" >User Email: " + singleobj.useremail + "</lable></div><br>";
                        ...
                        else
                        {
                            ...
                            ans2 += "<input type=\"button\" value=\"Cancel\" class=\"btn btn-danger\" onclick=\"pendingslot(" + singleobj.bookingid + ")\" >";
                            ans2 += "</div>";
...
<body onload="showslots()">
    <%@include file="vendor_navbar.jsp" %><br><br><br><br><br><br>
    <div class="container text-center text-success" ><br>
        <div style="border: 2px solid black; border-radius: 10px;margin: 20px;margin-left: 20px;margin-right: 20px ;background-color: white; padding: 20px" >
