    ...
    <head>
        ...
        <script>
            ...
            function showvendors()
            {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                       ...
                       // alert(res);
                        ...
                        for (var i = 0; i < arr.length; i++)
                        {
                            ...
                            ans = ans + "<div class= \"col-sm-2\" >";
                            ans = ans + "<div class=\"card-body\">";
                            ans = ans + "<label class=\"card-text\" style=\"font-size: 15px\" >Phone number : " + st.phoneno + "</label><br><br>";
                            ans = ans + "</div>";
                            ans = ans + "</div>";
                ...
                xhttp.open("POST", "./show_vendors_servlet", true);
...
<%@include file="Header.jsp"%>
    ...
    <body onload="showvendors()" style="background-color: #062c33" >
        <%@include file="adminNAVBAR.jsp" %>   <br><br><br><br><br><br><br><br><br>
